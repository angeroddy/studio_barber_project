...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        STUDIO BARBER - COUPE - BARBE - STYLE
      </InfiniteMarquee>
      <div className="other-section flex bg-white relative" >
        ...
        >
          <AnimatedSection variant="fadeIn" delay={0.2}>
            <h1 className='text-black font-archivo text-[32px] sm:text-[40px] md:text-[50px] lg:text-[60px] font-black leading-tight lg:leading-15 relative z-10 text-center'> DEUX BARBERSHOPS</h1>
          </AnimatedSection>
      ...
      <div className="other-section flex bg-white relative py-10 sm:py-14 md:py-16 lg:py-20">
        
        <div
          className="flex justify-center items-center salons-section px-4 sm:px-6 md:px-8 lg:px-10 flex-col relative w-full"

        >
          <h1 className='text-black font-archivo text-[32px] sm:text-[40px] md:text-[48px] lg:text-[55px] font-black leading-tight lg:leading-11 relative z-10 text-center'> GALERIE DE <br></br> PRESTATIONS</h1>
      ...
      {/* Section Tarifs */}
      <div className="tarifs-section flex bg-white relative py-10 sm:py-14 md:py-16 lg:py-20">
        
        <div className="flex justify-center items-center flex-col relative w-full px-4 sm:px-6 md:px-8 lg:px-10">
          <AnimatedSection variant="fadeIn" delay={0.2}>
            <h1 className='text-black font-archivo text-[32px] sm:text-[40px] md:text-[50px] lg:text-[60px] font-black leading-tight lg:leading-15 relative z-10 text-center mb-4'>TARIFS</h1>
          </AnimatedSection>
      ...
      {/* Section Itinéraire */}
      <div className="itinerary-section flex bg-white relative py-10 sm:py-14 md:py-16 lg:py-20">
        
        <div className="flex justify-center items-center flex-col relative w-full px-4 sm:px-6 md:px-8 lg:px-10">
          <AnimatedSection variant="fadeIn" delay={0.2}>
            <h1 className='text-black font-archivo text-[32px] sm:text-[40px] md:text-[50px] lg:text-[60px] font-black leading-tight lg:leading-15 relative z-10 text-center mb-4'>
      ...
      {/* Section Contact */}
      <div className="contact-section flex bg-[#DE2788] relative py-10 sm:py-14 md:py-16 lg:py-20">
        
        <div className="flex justify-center items-center flex-col relative w-full px-4 sm:px-6 md:px-8 lg:px-10">
          <AnimatedSection variant="fadeIn" delay={0.2}>
            <h1 className='text-white font-archivo text-[32px] sm:text-[40px] md:text-[50px] lg:text-[60px] font-black leading-tight lg:leading-15 relative z-10 text-center mb-4'>
              CONTACTEZ-NOUS
            </h1>
          </AnimatedSection>
          <AnimatedSection variant="fadeIn" delay={0.3}>
      ...
      <Footer2
        ...
        menuItems={[
          ...
          },
          {
            title: "Services",
            links: [
              { text: "Coupe Homme", url: "#" },
              { text: "Barbe", url: "#" },
              { text: "Coupe Enfant", url: "#" },
              { text: "Styling", url: "#" },
            ],
          },
          {
